...
|https://docs.cypress.io/guides/references/changelog.html#13-2-0[13.2.0]
...
3. Pull the *platform specific (linux/amd64) image* for cypress-included: docker pull --platform linux/amd64 cypress/included:12.9.0
